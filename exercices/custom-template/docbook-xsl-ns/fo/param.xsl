...
<xsl:param name="body.start.indent">
  <xsl:choose>
    ...
    <xsl:otherwise>1pc</xsl:otherwise><!-- CUSTOM (default:4pc) reduced indentation -->
  </xsl:choose>
</xsl:param>
...
<xsl:param name="page.margin.inner">
  <xsl:choose>
    ...
    <xsl:otherwise>.5in</xsl:otherwise><!-- CUSTOM (default:1in) reduced margin  -->
  </xsl:choose>
</xsl:param>
...
<xsl:param name="paper.type">A4</xsl:param><!-- CUSTOM (default:USletter) switched paper to A4 -->
...
<xsl:param name="toc.max.depth">1</xsl:param><!-- CUSTOM (default:4) limited table of content depth -->

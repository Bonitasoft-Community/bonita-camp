...
2. Spécifiant des contrats pour l'instanciation du processus et l'exécution des étapes humaines
...
2. Créer le BDM *DemandeConges* :
    ...
    *estApprouvee* | `Boolean` | ◻ | ◻
    ...
    - Cliquer sur **Ok**
3. Déclarer une variable métier de type *DemandeConges* dans le processus :
...
4. Configurer le contrat d'instanciation :
...
5. Configurer le contrat d'instanciation :
...
6. Modifier l'initialisation de la variable métier *demande* pour pouvoir récupérer l'initiateur de la nouvelle demande :
...
7. Configurer le contrat de l'étape *Valider demande* :
...
8. Noter qu'une opération (**Exécution / Opérations**) sur la tâche *Valider demande* pour mettre à jour la demande a automatiquement été générée

   ![opération générée automatiquement](images/ex02/ex2_06.png)
   
9. Configurer la condition sur la transition *Oui* à partir de l'attribut *estApprouvee* du BDM *demande* :
